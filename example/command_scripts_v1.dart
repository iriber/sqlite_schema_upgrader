...
class CommandScriptV1 extends CommandScript{
  ...
  Future<void> execute(Batch batch) async {
    batch.execute("CREATE TABLE log_data (id INTEGER PRIMARY KEY AUTOINCREMENT, message TEXT NOT NULL, datetime INTEGER)");

    batch.execute("INSERT INTO log_data(message) VALUES ('my first message',1)");
  }
